...
<div class="box box-warning">
    ...
    <form action="../../index2.html" method="post">
       <p class="14p">Remplissez ce formulaire pour cr�er votre profil</p>
     ...
     <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input class="form-control" placeholder="telephone" name="telephone">
         ...
         <p class="14p">Votre courriel servira � vous identifier lors de votre prochaine visite</p>
         <p class="text-red 10p">Le mot de passe doit avoir au moin 1 chiffre, 1 lettre et 8 caract�re minimum</p>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <div class="checkbox">
                  <label class="text-blue">
                    <input type="checkbox" >Souhaitez-vous recevoir les promotions et les nouveaut�s
                  </label>
                </div>
